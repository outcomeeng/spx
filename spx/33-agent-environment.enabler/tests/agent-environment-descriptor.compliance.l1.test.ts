...
function harnessEnvironmentPath(...segments: readonly string[]) {
...
function assertHarnessEnvironmentConfig(value: unknown): HarnessEnvironmentConfig {
