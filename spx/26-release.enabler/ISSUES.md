...
- `src/interfaces/cli/release.ts` — the release-notes output — agent-runner response text and CHANGELOG file content
- `src/interfaces/cli/release.ts` — the documentation-sync path line — filesystem paths
