...
If C1 branches while this branch is in progress, check `spx/16-config.enabler/PLAN.md` for the dispatcher-enforced merge-ordering guard before both are open simultaneously.
