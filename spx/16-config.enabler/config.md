...
- ALWAYS: validate and test configuration are registered as separate domain descriptors; shared shapes such as path include/exclude filters are reusable primitives, not command-local parsers ([review](21-descriptor-registration.adr.md))
