...
- Before invoking runtime config reconciliation for hermetic auditor execution, validate the resolved runtime state directory is contained by the branch-scoped `.spx/audit/{branch-slug}` run-state boundary and remains ignored local state.
