...
- ALWAYS: construct branch slugs through `spx/18-state.enabler/32-scope-addressing.enabler/` branch identity semantics, using the state module's default slug byte bound rather than audit configuration ([audit])
