...
- ALWAYS: construct branch slugs through `spx/34-state-store.enabler/` branch identity semantics, using state-store's default slug byte bound rather than audit configuration ([audit])
