...
- Given an audit run persists state, when the branch slug is known, then the state is written under `.spx/audit/{branch-slug}` at the Git common-dir product root ([audit])
