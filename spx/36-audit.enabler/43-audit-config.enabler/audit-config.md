...
- ALWAYS: audit storage vocabulary is descriptor-owned and not hardcoded outside the descriptor defaults ([test](tests/audit-config.compliance.l1.test.ts), [test](tests/audit-config.mapping.l1.test.ts), [review])
