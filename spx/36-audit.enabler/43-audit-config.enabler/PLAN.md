...
- Descriptor defaults include `.spx`, node verdict filenames, `baseRef`, auditor selection, and target filters.
- Branch run directories, run filenames, branch slug policy, and terminal JSONL records are state-store paths, not audit config fields.
