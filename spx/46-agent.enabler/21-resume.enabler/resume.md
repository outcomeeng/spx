...
- ALWAYS: Codex candidates include interactive Codex transcripts and exclude non-interactive Codex exec transcripts because `spx agent resume` launches through the interactive `codex resume` command ([test](tests/resume.compliance.l1.test.ts))
