...
- NEVER: discovery shells out to an external file-scanning binary or takes a runtime dependency beyond the injected filesystem, clock, home-directory, worktree-root, and numeric activity-window inputs ([audit])
