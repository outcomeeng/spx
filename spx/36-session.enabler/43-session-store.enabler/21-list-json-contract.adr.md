...
- ALWAYS: the `--fields` Commander option and all stdout/stderr writes live in the session descriptor, field-selection parsing and output assembly in the command handler, and the projection in the domain per [`spx/14-cli-composition.adr.md`](../../14-cli-composition.adr.md) ([audit])
