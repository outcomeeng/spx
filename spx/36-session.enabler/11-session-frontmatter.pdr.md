...
- On refusal, `SessionHandoffBaseError` renders a prerequisite checklist with one line per base prerequisite marked met or unmet, shown only when at least one prerequisite is unmet ([review])
