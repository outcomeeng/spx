...
- ALWAYS: store review run state under `.spx/review/{target-kind}/{target-slug}/runs/{run-directory}/` at the Git common-dir product root, per `spx/15-worktree-management.pdr.md` ([audit])
