...
SO THAT the agentic verdict-mode verification types `spx/36-audit.enabler` and `spx/46-reviewing.enabler`, and the storage adapters that implement the interface,
