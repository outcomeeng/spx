...
- ALWAYS: `spx agent config update` selects only package versions compatible with the declared methodology, persists exact pins through the config owner, and applies those versions ([test](tests/capability-update.compliance.l1.test.ts))
