...
PROVIDES deterministic management of repository-local agent harness environment configuration
SO THAT context ingestion, agentic verification, and agent-driven development workflows
CAN run with configured instructions, agents, plugin marketplaces, plugins, and skills
