...
**Evidence:** `grep -rn "createRecordingCommandRunner({ present: true, exitCode" spx testing --include=*.ts` reports 60 call sites; a test-evidence audit of `spx/41-test.enabler/90-targeted-execution.enabler` reported three of them as warnings.
