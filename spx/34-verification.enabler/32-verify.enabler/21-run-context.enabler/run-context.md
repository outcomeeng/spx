...
- NEVER: a verification-run scope type exposes `working-tree` without verification-context substrate representation for a working-tree subject kind and reconstruction fields ([test](tests/verify-scope.mapping.l1.test.ts))
