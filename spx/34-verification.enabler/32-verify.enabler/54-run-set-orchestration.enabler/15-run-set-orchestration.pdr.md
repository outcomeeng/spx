...
3. Finding identity is stable across line movement and producer releases by combining verification type, the verification-type-provided stable actor or producer component when defined, normalized subject, rule, and message or evidence fingerprint; line numbers, provider record identifiers, and producer provenance are display metadata.
...
- ALWAYS: finding identity remains stable when display-only line numbers, provider record identifiers, or producer provenance change but verification type, the verification-type-provided stable actor or producer component when defined, normalized subject, rule, and message or evidence fingerprint remain unchanged ([property])
