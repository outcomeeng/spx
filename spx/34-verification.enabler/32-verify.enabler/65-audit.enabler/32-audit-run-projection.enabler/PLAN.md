...
1. Implement the audit scope projection, terminal-rollup, and prior-context selector tests named by `spx/34-verification.enabler/32-verify.enabler/65-audit.enabler/32-audit-run-projection.enabler/audit-run-projection.md`.
