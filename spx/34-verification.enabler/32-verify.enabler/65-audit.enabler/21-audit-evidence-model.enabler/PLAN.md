...
1. Implement the audit scope, audit finding, and audit command-surface tests named by `spx/34-verification.enabler/32-verify.enabler/65-audit.enabler/21-audit-evidence-model.enabler/audit-evidence-model.md` and `spx/34-verification.enabler/32-verify.enabler/65-audit.enabler/audit.md`.
...
3. Migrate audit orchestrator and leaf auditor plugin callers after SPX validates and projects the audit payload shape.
