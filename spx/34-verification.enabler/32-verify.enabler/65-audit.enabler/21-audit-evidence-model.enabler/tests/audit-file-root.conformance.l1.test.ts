...
import { AUDIT_FILE_SCOPE_GENERATORS } from "@testing/generators/verify/audit";
...
describe.each(Object.entries(AUDIT_FILE_SCOPE_GENERATORS))(
  "audit file-root conformance: %s",
  (_kind, scenarioArbitrary) => {
