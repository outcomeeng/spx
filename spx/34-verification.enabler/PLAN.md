...
> Reconcile against `spx/spx.product.md`, `spx/34-verification.enabler/verification.md`, and the affected child node specs and decisions first. This note coordinates remaining verification work under the materialized verification node; it does not declare product truth.
