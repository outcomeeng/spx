...
3. Wire review-run callers to `spx verify --verification-type review --scope-type changeset --scope <base>..<head> --input stdin <verb>` and remove wrapper-owned journal-event construction.
