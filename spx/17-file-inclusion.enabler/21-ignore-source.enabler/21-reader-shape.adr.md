...
- ALWAYS: the factory accepts `productDir` per `spx/15-worktree-resolution.pdr.md` and `IgnoreSourceReaderConfig` carrying structured override flags, translating overrides into git plumbing arguments at construction ([audit])
