...
- SpxConfig interface and DEFAULT_CONFIG are type-consistent: the constant satisfies the interface without assertion ([test](tests/config-schema.unit.test.ts))
