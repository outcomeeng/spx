...
- ALWAYS: check marker files relative to the project root passed to the calling command ([audit])
- NEVER: prompt the user to install tools for languages the project does not use ([audit])
