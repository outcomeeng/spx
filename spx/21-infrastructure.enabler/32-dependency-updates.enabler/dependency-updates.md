...
- ALWAYS: routine automerges execute inside the daily early-morning window that opens at 05:00 Europe/Zurich time, while vulnerability-fix automerges execute at any hour ([audit])
