...
PROVIDES GitHub Actions integration for deterministic verification, release publication, dependency security checks, security scorecards, and agentic verdict-mode runs — including CI entrypoints for validation and testing, plus a Snapshot journal backend that publishes agentic verification run projections to GitHub-native surfaces
