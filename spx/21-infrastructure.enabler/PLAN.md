...
- Remaining generators `testing/generators/{agent-run-journal,audit/run-state,compact,release,github-snapshot,sonarqube-cloud,spec-tree}/*.ts` → their owning domain nodes (`15-agent-run-journal`, `36-audit/54-branch-run-state`, `37-compact`, `26-release`, `21-infrastructure/43-github-ci`, `23-spec-tree`)
