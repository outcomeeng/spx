...
- ALWAYS: `src/lib/precommit/main-checkout-gate.ts` delegates main-checkout classification to `isMainCheckout` from `src/git/root.ts`, which is governed by `spx/15-worktree-management.pdr.md` ([audit])
