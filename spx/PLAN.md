...
| ----- | ------------ | ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1     | Substrate    | Runtime, process, filesystem, Git, workflow, hook, package, and external-service mechanics. | `spx/21-infrastructure.enabler`, process-lifecycle and diagnostic mechanics under `spx/13-cli.enabler`, parts of `spx/33-harness-environment.enabler`.    |
