...
- ALWAYS: declared evidence-link facts enter the spec graph through injected tree-provider outputs, and implementation source files are never parsed to create spec graph edges ([test](tests/spec.compliance.l1.test.ts))
