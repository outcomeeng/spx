...
export const AGENT_RESUME_TEXT = {
  DESCRIPTION:
    "Resume Codex, Claude Code, or Pi sessions by worktree, or sessions with recorded branch metadata by branch",
...
const MS_PER_DAY = AGENT_RESUME_LIMITS.HOURS_PER_DAY
  * AGENT_RESUME_LIMITS.MINUTES_PER_HOUR
  * AGENT_RESUME_LIMITS.SECONDS_PER_MINUTE
  * AGENT_RESUME_LIMITS.MILLISECONDS_PER_SECOND;

/** Continuation reach: the conversation a user just left. */
export const AGENT_RESUME_RECENT_WINDOW_MS = AGENT_RESUME_LIMITS.RESUME_RECENT_DAYS * MS_PER_DAY;

/** Forensic reach: a session the user is trying to find again. */
export const AGENT_SEARCH_RECENT_WINDOW_MS = AGENT_RESUME_LIMITS.SEARCH_RECENT_DAYS * MS_PER_DAY;
